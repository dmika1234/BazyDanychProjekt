...
ALTER TABLE uzytkownicy ADD FOREIGN KEY (id_konta) REFERENCES konta(id_konta) ON UPDATE CASCADE ON DELETE SET NULL;

ALTER TABLE platnosci ADD FOREIGN KEY (id_konta)  REFERENCES konta(id_konta) ON UPDATE CASCADE ON DELETE SET NULL;

ALTER TABLE produkcje ADD CHECK (rok_produkcji BETWEEN 1800 AND 2100);

ALTER TABLE odcinki ADD FOREIGN KEY (id_produkcji) REFERENCES produkcje(id_produkcji) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE odtworzenia ADD FOREIGN KEY (id_produkcji) REFERENCES produkcje(id_produkcji) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE w_kategorii ADD FOREIGN KEY (id_produkcji) REFERENCES produkcje(id_produkcji) ON UPDATE CASCADE ON DELETE CASCADE;


ALTER TABLE oceny ADD FOREIGN KEY (id_produkcji) REFERENCES produkcje(id_produkcji) ON UPDATE CASCADE ON DELETE CASCADE;
